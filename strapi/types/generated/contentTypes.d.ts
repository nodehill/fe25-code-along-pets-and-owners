...
export interface ApiPetOwnerPetOwner extends Struct.CollectionTypeSchema {
  collectionName: 'pet_owners';
  info: {
    displayName: 'Pet Owner';
    pluralName: 'pet-owners';
    singularName: 'pet-owner';
  };
  options: {
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::pet-owner.pet-owner': ApiPetOwnerPetOwner;
